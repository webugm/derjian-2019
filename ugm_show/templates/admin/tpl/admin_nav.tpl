...
<{if $op=="opList"}>
  ...
  <div class="panel panel-primary">
    <div class="panel-heading"><h3 class="panel-title">選單管理</h3></div>
        ...
        <table id="form_table" class="table table-bordered table-striped table-hover">
          ...
          <tr id='tr_0' data-tt-id="0">
            <td class="text-left" colspan=<{$listTitles|@count}>>
              ...
              <a href="?op=opForm&kind=<{$kind}>&ofsn=0" class="btn btn-primary btn-xs" ait="在根目錄建立子選單">新增<i class="fa fa-plus" aria-hidden="true"></i></a>
            </td>
          </tr>
          <!-- 根目錄結束 -->
