...
<html lang="en">
  ...
  <head>
    ...
    <link href="<{$xoImgUrl}>vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><{$WEB.siteName}></a>
    ...
    <section class="p-0" id="portfolio">
      <div class="container-fluid p-0">
        <div class="row no-gutters popup-gallery">
          <{foreach from=$prodRows item=row key=k}> 
    ...
    <script src="<{$xoImgUrl}>vendor/scrollreveal/scrollreveal.min.js"></script>
