<?php
/* Smarty version 3.1.34-dev-7, created on 2020-02-19 02:45:59
  from 'D:\0_course\xampp\xampp\htdocs\web11\templates\tpl\user.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e4c9357d40e73_85555441',
...
function content_5e4c9357d40e73_85555441 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
				<tr>
					...
					<td>
						<?php if ($_smarty_tpl->tpl_vars['row']->value['kind']) {?>
...
"><i class="fas fa-edit"></i></a>
						<a href="javascript:;" onclick="op_delete(<?php echo $_smarty_tpl->tpl_vars['row']->value['uid'];?>
...
>
		function op_delete(uid) {
			Swal.fire({
				...
				if (result.value) {
					document.location.href="<?php echo $_smarty_tpl->tpl_vars['xoAppUrl']->value;?>
user.php?op=op_delete&uid="+uid;
				}
			});						
		}
	<?php echo '</script'; ?>
...
" readonly>
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label>密碼</label>
								<input type="text" class="form-control" name="pass" id="pass" value=""  autocomplete="off">
							</div>
						</div>
						<!-- 會員狀態 -->
						<div class="col-sm-4">
